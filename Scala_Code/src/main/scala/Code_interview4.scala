//https://github.com/aashreya/scala-interview-solutions/blob/master/src/main/scala/twoSumProblem.sc

/**
  * Created by User on 2/17/2019.
  */
object Code_interview4 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /*def twoSumMap(nums: Array[Int], target: Int): Array[Int] = {
      val elementsAsMap2: Map[Int, Int] = nums.zipWithIndex.foldLeft(Map[Int, Int])((a: Map[Int, Int], b: (Int, Int)) => a + (b._1 -> b._2))
